                                       ...
                                       uint32_t msQdelay)
{
  ...
  uint32_t packets=bufSize/DEFAULT_PACKET_SIZE;
  uint16_t handle = pfifoHelper.SetRootQueueDisc ("ns3::PfifoFastQueueDisc", "Limit", UintegerValue (packets));
  pfifoHelper.AddInternalQueues (handle, 3, "ns3::DropTailQueue", "MaxPackets", UintegerValue (packets));
